...
<html lang="ko">
    <head>
        ...
        <meta name="title" content="사진 카툰화와 동물상 테스트">
        ...
        <meta name="author" content="코딩탐험">

        <meta property="og:url" content="https://cartoonaf.com/<?php echo $serviceUri; ?>" />
        <meta property="og:type" content="website" />
        <meta property="og:title" content="사진 카툰화와 동물상 테스트" />
        <meta property="og:description" content="사진을 카툰으로 만들기와 얼굴로 보는 인공지능 동물상 테스트"/>
        <meta property="og:image" content="https://cartoonaf.s3.ap-northeast-2.amazonaws.com/public/<?php echo $imageUri; ?>" />
